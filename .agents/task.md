...
## FAZA 5 — Toplu İstifadəçi İdarəetməsi (Bulk Actions)
- [x] 5A: server.ts-də /api/admin/users/bulk-action endpoint-inin yazılması
- [x] 5B: AdminPanel.tsx-də checkbox seçim mexanizminin qurulması
- [x] 5C: AdminPanel.tsx-də toplu əməliyyat panelinin (Bulk Actions Bar) əlavə edilməsi
- [x] 5D: Test və yoxlamalar
