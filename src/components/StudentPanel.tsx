          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <SearchableSelect
                ...
                placeholder={language === 'AZ' ? 'Tədris Proqramı Seçin' : 'Select Curriculum Program'}
            ...
            <div>
              ...
              <SearchableSelect
                options={[
                  { value: '', label: language === 'AZ' ? 'Fənn seçilməyib (Ümumi proqram rəyi)' : 'No subject chosen (General program review)' },
